# Privacy Policy for PythagorasHIM™ for Obra Prima Web

## Introduction

Welcome to "PythagorasHIM™ for Obra Prima Web". This privacy policy outlines how we collect, use, and protect your information when you use our Chromium extension. We value your privacy and are committed to safeguarding your personal data in accordance with the highest standards of security and confidentiality.

By using "PythagorasHIM™ 4 Obra Prima Web", you agree to the collection and use of information in accordance with this policy. If you have any concerns about how your data is handled, please do not hesitate to contact us.

## 1. Information We Collect

PythagorasHIM™ 4 Obra Prima Web is designed to assist in auditing purchase orders on the Obra Prima Web platform. In the process, we may collect the following types of information:

### 1.1. Personal Information

- **Google Account Information**: If required for authentication, the extension may interact with your Google account to access basic profile information, including your email address.
- **Client Data**: The extension processes client names and related information, depending on your interactions with the extension.
...
- **Extension Activity Logs**: We may log activity related to the extension, such as when and how often it is used, to monitor performance and usage trends.

### 1.3. Data from Third Parties

- **Website Interaction**: The extension interacts with the Obra Prima Web platform, processing data such as purchase order details, search queries, and other relevant information to facilitate the audit process.

## 2. How We Use Your Information

The information we collect is used to provide, maintain, and improve PythagorasHIM™ 4 Obra Prima Web. Below are the specific ways in which your information may be used:

### 2.1. Service Operation

- **Data Processing**: The extension processes data from the Obra Prima Web platform to automate tasks such as searching and updating purchase orders.
...
- **Promotional Content**: With your consent, we may send you marketing communications related to PythagorasHIM™ 4 Obra Prima Web or other products and services from Takk™ Innovate Studio.
...
All data transmitted between your device and the Obra Prima Web platform is encrypted using industry-standard SSL (Secure Socket Layer) technology. This ensures that your data remains secure during transmission.
...
PythagorasHIM™ 4 Obra Prima Web may contain links to third-party websites or services that are not operated by us. If you click on a third-party link, you will be directed to that third party's site.
